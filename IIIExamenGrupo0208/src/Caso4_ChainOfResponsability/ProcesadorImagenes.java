 ...
 * @author Rigo-PC
 */
public class ProcesadorImagenes implements Procesador{
    private Procesador procesador;
    private String tipo;

    public ProcesadorImagenes(String tipo) {
        this.tipo = tipo;
    }
    ...
    public void procesarArchivo(Archivo archivo) {
        if(archivo.getTipo().equals(this.tipo)){
            System.out.println("Procesando IMAGEN llamada: "+archivo.getNombre()+
