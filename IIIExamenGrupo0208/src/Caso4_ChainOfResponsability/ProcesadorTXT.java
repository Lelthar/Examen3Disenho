 ...
 * @author Rigo-PC
 */
public class ProcesadorTXT implements Procesador{

    private Procesador procesador;
    private String tipo;

    public ProcesadorTXT(String tipo) {
        this.tipo = tipo;
    }
    ...
    public void procesarArchivo(Archivo archivo) {
        if(archivo.getTipo().equals(this.tipo)){
            System.out.println("Procesando ARCHIVO DE TEXTO llamado: "+archivo.getNombre()+
