 ...
 * @author Rigo-PC
 */
public class ProcesadorDocumentos implements Procesador{
    
    private Procesador procesador;
    private String tipo;

    public ProcesadorDocumentos(String tipo) {
        this.tipo = tipo;
    }
    ...
    public void procesarArchivo(Archivo archivo) {
        if(archivo.getTipo().equals(this.tipo)){
            System.out.println("Procesando DOCUMENTO llamado: "+archivo.getNombre()+
